...
class Mp3Genre(object):
    ...
    def __init__(self, path):
        self.path = "/Users/triangle/res_o/audio"
        self.mp3_list = []
        self.fun()
    ...
    def fun(self):
        ...
        将查找到的mp3添加到列表
        """
        for root, dirs, files in os.walk("/Users/triangle/res_o/audio/effect/ios/com/play"):
            dirs[:] = []
            for fn in files:
                mp3_path = root + "/" + fn
...
if __name__ == "__main__":
    mp3_genre = Mp3Genre(r"/Users/triangle/res_o/audio")
    mp3_genre.todo(u"摇滚")
